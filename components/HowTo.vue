    ...
    <div class="md:h-dvh flex flex-col md:flex-row items-center justify-center py-12 md:py-0 gap-12 md:gap-24 mb-12 md:mb-0">
      <div>
        <h1 class="text-4xl md:text-6xl font-theme font-bold mb-6">
          <span class="text-pink-700">Save</span> Everything, Effortlessly
        </h1>
...
<!--      <VideoDisplay videoUrl="/videoTest.MP4" />-->
      <div>
        <h1 class="text-4xl md:text-6xl font-theme font-bold mb-6">
          <span class="text-pink-700">Organize</span> Your World
        </h1>
    ...
    <div class="md:h-dvh flex flex-col md:flex-row items-center justify-center py-12 md:py-0 gap-12 md:gap-24 mb-12 md:mb-0">
      <div>
        <h1 class="text-4xl md:text-6xl font-theme font-bold mb-6">
          <span class="text-pink-700">Collaborate</span>with Ease
        </h1>
        <p class="text-gray-700 text-lg">
